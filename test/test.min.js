...
3;a.equal($("#t-5").lst2cols(b).children("li").length,9,"lr method set to 3 columns");b.colNum=10;a.equal($("#t-6").lst2cols(b).children("li").length,8,"lr method set to 10 columns too many should create 8 (1 item per column)")});
